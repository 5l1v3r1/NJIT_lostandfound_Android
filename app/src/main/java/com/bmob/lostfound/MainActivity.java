...
public class MainActivity extends BaseActivity implements OnClickListener,
	...
	public static List<Lost> losts = new ArrayList<Lost>();
	private void queryLosts() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
		        ...
		        String url = "http://182.254.133.173/androidapi/get_all_lost_items.php";
		            ...
		            if (res != null && !res.trim().equals("")){
		                ...
		                if (jsonObject.getInt("success") == 1){
		                    ...
		                    for (int i = jsonArray.length()-1;i >=0;i--){
		                        ...
		                        Lost lost = new Lost();
		                        lost.setTitle(what);
		                        String des = "地点：" + (where == null?"":where) +"-----"+"时间：" + (when == null?"":when)+"\r" + (detail == null?"":detail);
	...
	public static List<Found> founds = new ArrayList<Found>();
	public void queryFounds() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				OkHttpClient okHttpClient = new OkHttpClient();
				String url = "http://182.254.133.173/androidapi/get_all_found_items.php";
				Request request = new Request.Builder()
						.url(url)
						.build();
				Call call = okHttpClient.newCall(request);
